...
2.  **Primo Anno**: Nel primo anno dopo l'inizio ($n=1$), il CAGR coincide con la *crescita semplice: $$\left( \frac{\text{Valore Finale- Valore Iniziale}}{\text{Valore Iniziale}} \right)$$*. 
