...
if uploaded_file is not None:
    try:
        ...
        if not df_plot.empty:
          ...
          # --- GRAFICO 3D CON HOVER PERSONALIZZATO ---
        ...
        fig_3d = px.scatter_3d(
            ...
            size='Aiuti Target',
            hover_name='Ragione Sociale',
            custom_data=custom_data_list, # CRITICO: passiamo i dati qui
            log_y=True,
            log_z=True,
        ...
        # 2. Applichiamo il tuo Hovertemplate
        ...
        st.plotly_chart(fig_3d, use_container_width=True, key="grafico_3d_specializzato")           
